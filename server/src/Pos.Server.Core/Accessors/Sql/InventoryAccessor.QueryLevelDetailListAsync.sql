SELECT i.StoreId, s.Name AS StoreName, i.ProductId, p.Code AS ProductCode, p.Name AS ProductName, p.CategoryId, c.Name AS CategoryName, i.Quantity, i.UpdatedAt
