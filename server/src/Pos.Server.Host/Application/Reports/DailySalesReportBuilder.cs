namespace Pos.Server.Host.Application.Reports;
...
public sealed class DailySalesReportBuilder
{
    ...
    public byte[] Build(DailySalesReport report)
    {
    ...
    private void EditSheet(TemplateSheet sheet, DailySalesReport report)
    {
