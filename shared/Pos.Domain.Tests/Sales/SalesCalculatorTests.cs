...
public sealed class SalesCalculatorTests
{
    // api-design §4.6 の例。全数値が一致すること
    [Fact]
    public void CalculateExample()
    {
        var result = SalesCalculator.Calculate(SalesExample.Input());
    ...
    public void CalculateThrowsForUnknownDiscountLine()
    {
        ...
        Assert.Throws<ArgumentException>(() => SalesCalculator.Calculate(input));
    }
}
