...
public static class SalesCalculator
{
    public static SalesResult Calculate(SalesInput input)
    {
        ...
        var allocatedDiscounts = Allocation.Allocate(transactionDiscount, bases);
        ...
        var tax = TaxCalculator.Calculate(taxLines, input.TaxRounding);
        ...
        var pointsRedeemed = Allocation.Allocate(pointsRedeemedTotal, netAmounts);
