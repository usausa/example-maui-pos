...
public sealed class ReportSalesSummaryResponse
{
    ...
    public ReportSalesSummaryResponseRow Total { get; set; } = default!;
}

public sealed class ReportSalesSummaryResponseRow
{
