...
| 受注の前受金 | 端末のシフトで受け取り (現金は予想現金に入る)、会計で全額を前受金の支払として充てる。キャンセルは返してから | [D-77](#d-77-受注の前受金-シフトで受け取り会計で全額を充てキャンセルは返してから) |
...
- 前受金の受け取りの控え (預り証) は印刷しない (端末の印刷は [D-68](#d-68-端末の印刷は-bluetooth-ラインプリンタを前提にし今は作らない) で後回し)
